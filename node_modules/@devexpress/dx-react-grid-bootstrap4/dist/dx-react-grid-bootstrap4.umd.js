...
(function (global, factory) {
  ...
  var Column = React.memo(function (_ref2) {
  ...
  var SortingIndicator = React.memo(function (_ref) {
  ...
  var Cell = function Cell(_ref) {
    ...
    return React.createElement("td", _extends({
      ...
      column: column,
      row: row
    }, children), inlineSummaries.length ? React.createElement(InlineSummary, {
  ...
  var Content = function Content(_ref) {
    ...
    return React.createElement("span", restProps, React.createElement("strong", null, column.title || column.name, ":", ' '), children || String(row.value));
  };
  ...
  var Row = function Row(_ref) {
    ...
    return React.createElement(TableRow, _extends({}, restProps, {
  ...
  var InlineSummary = function InlineSummary(_ref) {
    ...
    return React.createElement("span", _extends({
      ...
      return React.createElement(InlineSummaryItem, {
        key: s.type,
        summary: s,
        getMessage: getMessage
      });
  ...
  var SummaryCell = function SummaryCell(_ref) {
    ...
    return React.createElement(TableCell, _extends({}, restProps, {
      onClick: onToggle
    }));
  };
  ...
  var TableReorderingCell = function TableReorderingCell(_ref) {
    ...
    var refHandler = function refHandler(node) {
      return node && getCellDimensions(function () {
        return dxGridCore.getCellGeometries(node);
      });
    };
  ...
  var TableTreeIndent = React.memo(function (_ref) {
  ...
  var TableInlineCellEditing = dxReactCore.withComponents({
    Cell: EditCell
  ...
  var ExportPanel = dxReactCore.withComponents({
